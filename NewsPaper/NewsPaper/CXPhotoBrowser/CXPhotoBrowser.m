...
static CGFloat kNavigationBarViewHeightPortrait = 64;
...
- (CGRect)frameForPageAtIndex:(NSUInteger)index
{
    ...
    pageFrame.origin.y = kNavigationBarViewHeightPortrait;
    pageFrame.size.height -= kNavigationBarViewHeightPortrait;
    return pageFrame;
}
